...
class SpanishAsrDataModule:
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            help="Path to directory with Spanish cuts.",
        )
        group.add_argument(
            "--train-cuts",
            type=str,
    ...
    def train_cuts(self) -> CutSet:
        ...
        return load_manifest_lazy(
            self.args.manifest_dir / self.args.train_cuts
        )
    ...
    def test_cuts(self) -> CutSet:
        ...
        return load_manifest_lazy(
            self.args.manifest_dir / self.args.test_cuts
        )
